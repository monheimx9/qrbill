use qrbill::{
    esr, iso11649::Iso11649, Address, Language, QRBill, QRBillOptions, Reference, StructuredAddress,
};
/// Examples taken from
///
...
mod tests {
    ...
    #[case::c3a("3a")]
    #[case::c3b("3b")]
    fn test_name(sample_bills: HashMap<&'static str, QRBill>, #[case] id: &str) {
